  <!-- safari blue -->
  <section class="area" id="stoneTown" style="background-image: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(assets/imegs/background/blue1.jpg)" >
                <h1>Stone Town</h1>    
                    <p>
                        ...
                        <h3>Tour include:</h3> 
                        <p>Lunch,soft drink and water</p>
                        <h3>Exclude:</h3>
                        <p>Beer and all alcoholic beverage</p>
                </section>
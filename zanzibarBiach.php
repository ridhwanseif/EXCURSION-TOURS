...
<div class="row">
    ...
    <!-- Nungwi to Kizimkazi -->
<div class="box-area" id="BiachNungwiToKizimkazi">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                                ...
                                <div class="slider-area">
                                    <figure>
                                        <div class="slide">
                                            <img src="assets/imegs/zanzibar/g2.jpg" alt="">
                                        </div>
                                        <div class="slide">
                                            <img src="assets/imegs/zanzibar/g1.jpg" alt="">
                                        </div>
                                        <div class="slide">
                                            <img src="assets/imegs/background/oldest.jpg" alt="">
                                        </div>
                    ...
                    <h5>Distance from Zanzibar airpot to Nungwi is 68.3km via Nungwi road and it takes around one hour with 30 minutes drive (1h:30m) </h5>
                            ...
                            <div class="price">
                                ...
                                <div class="input-group-append">
                                    <a href="booking.php">
                                <button type="submit" class="input-group-text btn">Book Now</button></a>
                                </div>
                    </div>
...
<!-- Uroa to Jambian -->
<div class="box-area" id="BiachUroaToJambian">
<div class="gallary-north-box">
              <div class="row">
...
<!-- matemwe to michamvi-->
<div class="box-area" id="BiachMatemwetoMichamvi">
<div class="gallary-north-box">
              <div class="row">
...
<!-- Kiwengwa to Kendwa -->
<div class="box-area" id="biachKiwengwatoKendwa">
            <div class="gallary-north-box">
                        <div class="row">
...
<!-- Stone town to paje -->
<div class="box-area" id="biachStonetowntoPaje">
                <div class="gallary-north-box">
                        <div class="row">
